...
// #cgo CFLAGS: -I${SRCDIR} -I${SRCDIR}/lib/include
// #cgo darwin LDFLAGS: -L${SRCDIR} -L${SRCDIR}/lib/darwin -lkakasi -lkakasi_wrapper
// #cgo linux LDFLAGS: -L${SRCDIR} -L${SRCDIR}/lib/linux -lkakasi
...
import (
	...
	_ "github.com/aerex/go-anki/third_party/kakasi/dict"
	_ "github.com/aerex/go-anki/third_party/kakasi/lib/darwin"
	_ "github.com/aerex/go-anki/third_party/kakasi/lib/include"
	_ "github.com/aerex/go-anki/third_party/kakasi/lib/linux"
)
